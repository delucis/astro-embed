...
<CardGrid stagger>
    ...
    <Card title="Mastodon" icon="mastodon">
    	...
    	Embed the contents of a Mastodon post without client-side JavaScript.

    	[Mastodon Post docs](/components/mastodon/)
    ...
    <Card title="Bandcamp" icon="seti:audio">

    	Load Bandcamp embeds on user interaction for faster page loads.

    	[Bandcamp docs](/components/bandcamp/)
