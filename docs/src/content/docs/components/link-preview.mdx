...
You can customise it with CSS by targeting the `.link-preview` class.

### Custom properties API

The `<LinkPreview>` component also supports a minimal API for controlling its styles by setting some CSS custom properties.
